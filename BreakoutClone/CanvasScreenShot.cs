 ...
 */
    ...
    //takes Screenshot
    public void takeScreenShot(Canvas canvasPanel, RectTransform panel, SCREENSHOT_TYPE screenShotType = SCREENSHOT_TYPE.IMAGE_AND_TEXT, bool createNewInstance = true ) {
        StartCoroutine(_takeScreenShot(canvasPanel, panel, screenShotType,  createNewInstance));
    }

    private IEnumerator _takeScreenShot(Canvas canvasPanel, RectTransform panel, SCREENSHOT_TYPE screenShotType = SCREENSHOT_TYPE.IMAGE_AND_TEXT,  bool createNewInstance = true) {
     ...
     //   showCanvasExcept(allOtherCanvas, canvasPanel, false);
      ...
      //  RenderMode defaultRenderMode;
        ...
        Texture2D screenImage = new Texture2D((int)(panel.rect.width * canvasPanel.scaleFactor),(int) (panel.rect.height * canvasPanel.scaleFactor));
        //Get Image from screen
        screenImage.ReadPixels(new Rect(0,250 * canvasPanel.scaleFactor, (int)(panel.rect.width * canvasPanel.scaleFactor), (int)(panel.rect.height * canvasPanel.scaleFactor)), 0, 0);
        screenImage.Apply();
